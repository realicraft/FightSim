...
//var timeboxInfo = [57, "day", "sunny", "Day", "Clear Skies"]

var headerCont = '<div class="header"><span class="small_icon fs1" style="position:absolute;left:4px;top:4px;" title="FS1"></span>'
for (var i in headerLinks["1"]) {headerCont += '\n<a href="' + headerLinks["1"][i][1] + '">' + headerLinks["1"][i][0] + '</a>'}
