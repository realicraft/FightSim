var egglist = { // year: [name, css class, code, description, reward]
    ...
    "2024": [
        ["Plain Egg", "egg_plain", "null", "Someone forgot to paint this egg.", "Nothing, because this egg is a placeholder."], //0
        ["Plain Egg", "egg_plain", "getthebrushout", "Someone forgot to paint this egg. How sad.", "An egg."], //1
        ["Red Egg", "egg_red", "notatomato", "An egg that's been dyed red.", "2 Red Dye, 2 Tomatoes"], //2
        ["Orange Egg", "egg_orange", "likethecolor", "An egg that's been dyed orange.", "2 Orange Dye, 2 Oranges"], //3
        ["Yellow Egg", "egg_yellow", "sunnyside", "An egg that's been dyed yellow.", "2 Yellow Dye, 2 Wheat"], //4
        ["Green Egg", "egg_green", "gurinu", "An egg that's been dyed green.", "2 Green Dye, 2 Cabbage"], //5
        ["Cyan Egg", "egg_cyan", "stillnotlightblue", "An egg that's been dyed cyan.", "2 Cyan Dye, 2 Sleep Shrooms"], //6
        ["Blue Egg", "egg_blue", "bluheavy", "An egg that's been dyed blue.", "2 Blue Dye, 2 Blueberries"], //7
        ["Purple Egg", "egg_purple", "blurple", "An egg that's been dyed purple.", "2 Purple Dye, 2 Grapes"], //8
        ["White Egg", "egg_white", "mightneedabrush", "An egg that's been dyed white. Or maybe it's naturally white. Who knows?", "2 White Dye, 3 Bones"], //9
        ["Monochrome Egg", "egg_mono", "hurry", "ee ah oo ee &nbsp;ee ee oo ah &nbsp;ah oh ah ah &nbsp;ee ah oo ee</br>ee oo ee ee &nbsp;ee ah ee ah &nbsp;ah oh ah oh &nbsp;ee ee oo ah", "150% Myst. Skill 4 Exp"], //10
        ["Iron Egg", "egg_iron", "itgoesthunk", "It's basically just a large nugget.", "3 Iron Bars"], //11
        ["Copper Egg", "egg_copper", "decicoins", "You sure this is an egg?", "3 Copper Bars"], //12
        ["Gold Egg", "egg_gold", "thegoosegoeshonk", "But where's the goose?", "3 Gold Bars"], //13
        ["Hardite Egg", "egg_hardite", "maybeillcallyouback", "This is probably the most valuable one.", "3 Hardite Bars"], //14
        ["Broken Egg", "egg_broke", "whobrokeit", "It's a good thing these eggs aren't fertilized.", "Everyone but you takes 5 damage"], //15
        ["Fire Egg", "egg_fire", "iappeartohave", "An egg that's been dyed red and orange.", "Someone random is set On Fire"], //16
        ["Blue Fire Egg", "egg_blue_fire", "burstintoflames", "An egg that's been dyed blue and cyan.", "Someone random is Frozen"], //17
        ["Chocolate Egg", "egg_chocolate", "probablynotinthepantry", "This better be filled with something edible.", "Everyone gets a chocolate egg."], //18
        ["Egg Outline", "egg_vanish", "stickerslot", "There is no egg. Or spoon.", "Nothing"], //19
        ["Gradient Egg", "egg_gradient", "colouric", "An egg that's been dyed every color of the rainbow.", "16 random dyes"], //20
        ["Mono Gradient Egg", "egg_mono_gradient", "grayscalic", "An egg that's been dyed every shade of gray.", "16 random colorless dyes"], //2
        ["Stick Egg", "egg_stick", "justthehead", "An egg that looks like a stick figure.", "16 Sticks"], //22
        ["Egg Sticker", "egg_sticker", "youcantequipit", "A sticker that looks like an egg.", "3 random stickers."], //23
        ["Raised Egg Sticker", "egg_raised_sticker", "stoptrying", "A raised sticker that looks like an egg.", "2 random raised stickers."], //24
        ["Small Egg", "egg_small", "liketheswords", "A small egg.", "An egg."], //25
        ["Code Egg", "egg_code", "esoegg", "An egg made of code.", "An Esolang"], //26
    ]
}