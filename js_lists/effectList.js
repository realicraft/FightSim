var effectlist = [ //[name, css class for icon, description, source, bonuses, [categories], name class id]
    ...
    ["Deep Sleep", "sleep", "Hey, wake up already!", "Sleeping", "Can't do anything<br />Can attempt to wake up, 45% success rate<br />Getting hit replaces this effect with Asleep", [34, 35], 2], //22
