var effectlist = [ //[name, css class for icon, description, source, bonuses, [categories], name class id]
    ...
    ["Paralyzed", "paralyzed", "Bzzzt!", "Electricity", "Actions have a 1/4 chance of failing<br />If an action fails due to this, you take 4 damage", [34, 35, 51], 1], //5
    ...
    ["Night Vision", "night_vision", "You are better at seeing at night.<br /><br />Since your sight during the night is basically the same as during the day, this is just a night-locked sight boost.", "Potions", "Does nothing during daytime or dawn<br />+1 All Accuracy<br />+2 AGI/DEX<br />+1 to all Skills", [34, 36], 2], //39
    ["Fire-charged", "on_fire", "You're engulfed in a surprisingly harmless layer of fire. You should put it somewhere.", "Unknown", "Expended on melee attack to deal 10 <span class='fire'>Fire</span> damage<br />Auto-expended when melee attacked<br />Can be turned into 3 Fire", [34, 36, 49], 3], //40
    ["Water-charged", "soaked", "You're covered in a layer of water (yet you can still breathe). You should put it somewhere.", "Unknown", "Expended on melee attack to deal 10 <span class='water'>Water</span> damage<br />Auto-expended when melee attacked<br />Can be turned into 3 Water", [34, 36, 50], 3], //41
    ["Thunder-charged", "paralyzed", "You're brimming with electricity. You should put it somewhere.", "Lighting", "Expended on melee attack to deal 10 <span class='electric'>Electric</span> damage<br />Auto-expended when melee attacked<br />Can be turned into 3 Batteries", [34, 36, 51], 3], //42
    ["Slight Healing", "regen", "You're recovering a little bit of health.", "Potions", "+1 HP/turn", [34, 36], 1], //43
    ["Slight Strength", "atk_up", "You feel just a bit stronger.", "Potions", "+1 Indirect Attack", [34, 36], 1], //44
    ["Slight Resistance", "def_up", "You feel just a bit sturdier.", "Potions", "+1 Indirect Defense", [34, 36], 1], //45
]