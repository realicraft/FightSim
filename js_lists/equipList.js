var equiplist = [ //[name, css class for icon, description, source, bonuses, [categories], name class id]
    ...
    ["Water", "water", "One (1) level of water. Good for 0.5 turns of plant growth.", "Gathering", "", [11], 1], //74
    ...
    ["Esolang", "esolang", "An \"esoteric language\". You're not sure what it does, are how to use it, but that's the fun part!<br />Skill level: ", "Unknown", "Does something random on use<br />Usually fails, chance of failure decreases with higher Skill level<br />Using it increases Skill level", [29,20], 4], //248
    ...
    ["Bucket", "bucket", "A bucket. It can hold liquids, or be used as a helmet.", "Crafting", "Equip for +0.7 Direct Defense", [1,11,20], 1], //304
