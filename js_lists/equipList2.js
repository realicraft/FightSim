...
var snowball_name_gen = function(id, dv=0, stack=1, nbt={}) {
    if (("rock" in nbt) && (nbt["rock"] == true)) {
        return getTranslatedString("item.snowball_with_rock.name");
    } else {
        return getTranslatedString("item.snowball.name");
    }
}
var snowball_desc_gen = function(id, dv=0, stack=1, nbt={}) {
    if (("rock" in nbt) && (nbt["rock"] == true)) {
        return getTranslatedString("item.snowball_with_rock.desc");
    } else {
        return getTranslatedString("item.snowball.desc");
    }
}
var snowball_cats_gen = function(id, dv=0, stack=1, nbt={}) {
    if (("rock" in nbt) && (nbt["rock"] == true)) {
        return [21,53];
    } else {
        return [11,21,53];
...
var snowball_sell_gen = function(id, dv=0, stack=1, nbt={}) {
    if (("rock" in nbt) && (nbt["rock"] == true)) {
        return 0;
    } else {
        return 1;
...
var equiplist = [ //[name, css class for icon, description, source, bonuses, [categories], name class id, sell price]
    ...
    [
        ...
        ["Spruce Log", "spruce_log", "A spruce log.", "Chopping", "", [17], 1, 8], //2
        ["Acacia Log", "acacia_log", "An acacia log.", "Chopping", "", [17], 1, 8], //3
        ["Dark Oak Log", "dark_oak_log", "A dark oak log.", "Chopping", "", [17], 1, 8], //4
        ["Jungle Log", "jungle_log", "A jungle log.", "Chopping", "", [17], 2, 8], //5
    ], //44
    ...
    [
        ...
        ["Spruce Planks", "spruce_planks", "Some spruce planks.", "Chopping", "Counts as 2 fuel units", [11,17,27], 1, 2], //2
        ["Acacia Planks", "acacia_planks", "Some acacia planks.", "Chopping", "Counts as 2 fuel units", [11,17,27], 1, 2], //3
        ["Dark Oak Planks", "dark_oak_planks", "Some dark oak planks.", "Chopping", "Counts as 2 fuel units", [11,17,27], 1, 2], //4
        ["Jungle Planks", "jungle_planks", "Some jungle planks.", "Chopping", "Counts as 2 fuel units", [11,17,27], 2, 2], //5
    ], //46
    ...
    [
        ...
        ["Spruce Plank Wall", "spruce_wall", "A wall made of Spruce Planks.", "Crafting", "", [19,20], 1, 3], //2
        ["Acacia Plank Wall", "acacia_wall", "A wall made of Acacia Planks.", "Crafting", "", [19,20], 1, 3], //3
        ["Dark Oak Plank Wall", "dark_oak_wall", "A wall made of Dark Oak Planks.", "Crafting", "", [19,20], 1, 3], //4
        ["Jungle Plank Wall", "jungle_wall", "A wall made of Jungle Planks.", "Crafting", "", [19,20], 2, 3], //5
    ], //85
    ...
    [
        ...
        ["Spruce Table", "spruce_table", "A table made of spruce planks. You can put things on it.", "Crafting", "Place it down as a Structure", [18], 1, 3], //2
        ["Acacia Table", "acacia_table", "A table made of acacia planks. You can put things on it.", "Crafting", "Place it down as a Structure", [18], 1, 3], //3
        ["Dark Oak Table", "dark_oak_table", "A table made of dark oak planks. You can put things on it.", "Crafting", "Place it down as a Structure", [18], 1, 3], //4
        ["Jungle Table", "jungle_table", "A table made of jungle planks. You can put things on it.", "Crafting", "Place it down as a Structure", [18], 2, 3], //5
    ], //144
    [
        ["Oak Chair", "oak_chair", "A chair made of oak planks. You can sit on it.", "Crafting", "", [18], 1, 2], //0
        ["Birch Chair", "birch_chair", "A chair made of birch planks. You can sit on it.", "Crafting", "", [18], 1, 2], //1
        ["Spruce Chair", "spruce_chair", "A chair made of spruce planks. You can sit on it.", "Crafting", "", [18], 1, 2], //2
        ["Acacia Chair", "acacia_chair", "A chair made of acacia planks. You can sit on it.", "Crafting", "", [18], 1, 2], //3
        ["Dark Oak Chair", "dark_oak_chair", "A chair made of dark oak planks. You can sit on it.", "Crafting", "", [18], 1, 2], //4
        ["Jungle Chair", "jungle_chair", "A chair made of jungle planks. You can sit on it.", "Crafting", "", [18], 2, 2], //5
    ], //145
    ...
    [["Sticker Book", "sticker_book", "A book for you to put stickers in.", "Free", "Put stickers in it", [33,59], 4, 0]], //309
    [["Sticker Page", "sticker_page", "An extra page for your sticker book. Fits 4 stickers.", "Crafting", "Put it in your Sticker Book", [20,33,59], 3, 0]], //310
    ...
    [[snowball_name_gen, "snowball", snowball_desc_gen, "Crafting", "Throw it at someone to deal 1 <span class=\"ice\">Ice</span> damage", snowball_cats_gen, 1, snowball_sell_gen]], //374
    [["Empty Slot", "unused", "This slot used to have an item, but now it doesn't. (Snowball with a rock in it; 375 -> 374{\"rock\": true})", "", "", [], 0, 0]], //375
    ...
    [
        ...
        ["Spruce Button", "spruce_button", "A button made of spruce planks. You can push it to make electricity flow.", "Crafting", "", [17], 1, 3], //1
        ["Acacia Button", "acacia_button", "A button made of acacia planks. You can push it to make electricity flow.", "Crafting", "", [17], 1, 3], //1
        ["Dark Oak Button", "dark_oak_button", "A button made of dark oak planks. You can push it to make electricity flow.", "Crafting", "", [17], 1, 3], //1
        ["Jungle Button", "jungle_button", "A button made of jungle planks. You can push it to make electricity flow.", "Crafting", "", [17], 2, 3], //1
    ], //377
    ...
    [
        ...
        ["Birch Pressure Plate", "birch_plate", "A pressure plate made of birch planks. You can push it to make electricity flow.", "Crafting", "", [17], 1, 4], //1
        ["Spruce Pressure Plate", "spruce_plate", "A pressure plate made of spruce planks. You can push it to make electricity flow.", "Crafting", "", [17], 1, 4], //1
        ["Acacia Pressure Plate", "acacia_plate", "A pressure plate made of acacia planks. You can push it to make electricity flow.", "Crafting", "", [17], 1, 4], //1
        ["Dark Oak Pressure Plate", "dark_oak_plate", "A pressure plate made of dark oak planks. You can push it to make electricity flow.", "Crafting", "", [17], 1, 4], //1
        ["Jungle Pressure Plate", "jungle_plate", "A pressure plate made of jungle planks. You can push it to make electricity flow.", "Crafting", "", [17], 2, 4], //1
    ], //380
    ...
    [["Construction Upgrade", "upgrade_construction", "An upgrade square that upgrades Construction.", "Summon/Ally", "+1 Construction", [44], 1, 0]], //464
    ...
    [["Halloween Bucket", "halloween_bucket", "A pumpkin-shaped bucket. You put candy in it during Halloween, and then you can take then candy out afterward.", "Halloween", "Hold it to access the 7 item slots it has<br />Can store any candy<br />After Halloween, will disappear when empty", [12,29,48,59], 4, 0]], //697
    [
    ...
    [["Metallic Triangle", "metal_triangle", "A triangle made out of metal.", "Crafting", "+1.2 Direct Attack<br />+2.4 Indirect Attack", [5,23], 1, 8]], //723
    [
