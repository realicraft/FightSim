...
var headerCont = '<div class="header"><span class="small_icon fs2" style="position:absolute;left:4px;top:4px;" title="FS2"></span>'
for (var i in headerLinks["2"]) {headerCont += '\n<a href="' + headerLinks["2"][i][1] + '">' + headerLinks["2"][i][0] + '</a>'}
