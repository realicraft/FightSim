...
var user_data = {
    "realicraft":{"type":0,"health":[96,100],"attack":[10,10],"defense":[5,5],"kills":1,"deaths":1,"skills":[[6,0,25]],"effects":[]},
    ...
    "cheesyfriedeggs":{"type":0,"health":[86,100],"attack":[10,10],"defense":[5,5],"kills":0,"deaths":1,"skills":[[4,0,90],[1,0,77]],"effects":[]},
    "solitare":{"type":0,"health":[86,100],"attack":[10,10],"defense":[5,5],"kills":0,"deaths":0,"skills":[[2,0,60],[5,0,30],[3,0,65]],"effects":[]},
...
for (var i in user_data) {
    ...
    stat_table += ' type_icon"></span></span><h2 class="username">' + i + '</h2><div class="meter_container"><div class="health_disp"><span class="icon health"></span><span class="vat">'
    stat_table += user_data[i]["health"][0]
    stat_table += '</span><span class="vat" style="font-size: 25px;">/</span><span class="vab">'
    stat_table += user_data[i]["health"][1]
    stat_table += '</span></div><div class="combat_disp"><span class="icon attack"></span><span class="vat">'
    stat_table += user_data[i]["attack"][0] + " (" + user_data[i]["attack"][1]
    stat_table += ')</span><span class="vat" style="font-size: 25px;">/</span><span class="vab">'
    stat_table += user_data[i]["defense"][0] + " (" + user_data[i]["defense"][1]
    stat_table += ')</span><span class="icon defense"></span></div><div class="kd_disp"><span class="icon swing"></span><span class="vat">'
    stat_table += user_data[i]["kills"]
    stat_table += '</span><span class="vat" style="font-size: 25px;">/</span><span class="vab">'
    stat_table += user_data[i]["deaths"]
    stat_table += '</span><span class="icon broken_shield"></span></div></div>'
